...
const Ayraadapt = () => {
  return (
    <>
      <div className="bg-[url('/opencanvas/opc-img02-choose.jpg')] h-[90vh] bg-cover bg-center text-white relative m-10">
        {/* Centered paragraph at bottom */}
        <div className="absolute bottom-10 text-center px-4 w-1/2 left-[75%] transform -translate-x-1/2">
