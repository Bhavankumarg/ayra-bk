    ...
    return (
        <div className="flex justify-center">
            ...
            >
                ...
                <div
                    className={`absolute w-80 h-2 bg-black bottom-[-8px] left-0 transform-gpu origin-left transition-all duration-700 z-50 rounded-b-full`}
                ...
                <div
                    className={`absolute w-80 h-20 bg-blue-500 bottom-[-80px] left-[320px] transform-gpu origin-left transition-all duration-700 ${showSecond ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
                        } rounded-b-full`}
                    style={{
                        transform: showSecond ? "rotateY(0deg)" : "rotateY(-160deg)",
                        zIndex: showSecond ? 40 : 20,
                ...
                <div
                    className={`absolute w-80 h-20 bg-blue-500 bottom-[-80px] left-[640px] transform-gpu origin-left transition-all duration-700 ${showThird ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
                        } rounded-b-full`}
                    style={{
                        transform: showThird ? "rotateY(0deg)" : "rotateY(-160deg)",
                        zIndex: showThird ? 30 : 10,
